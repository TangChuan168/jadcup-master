...
const MyTable = (props: any) => {
  ...
  console.log('MyTable22,getCookie', getCookie("accessmentPlanId"));
  // getCookie
    ...
    if (assessment.length > 0) {
      ...
      for (let i = 0; i < assessment.length; i++) {
        ...
        data.push({
          ...
          acceStandardId: each.acceStandard.name,
          plan: each.accessmentPlan.notes,
        });
      }
      console.log('MyTable,data', data);
      // data = data.filter((e: any)=> e.accessmentPlanId == getCookie("accessmentPlanId"))
      setSource(data)
    }
  ...
  return (
    ...
    >
      ...
      > 
      <Link to='/assessment-plan' >Back to plan</Link>
