...
//delete
export default async (code:string, required:string) => {
    const vfsFonts = await import("pdfmake/build/vfs_fonts");    
    const {vfs} = vfsFonts.pdfMake;
    pdfMake.vfs = vfs;
    // const testTable1 = tables(data)
    const testTable = contents(code)
...
const contents = (code:string) =>{
    let ret:object[] = [];
        ...
        ret.push({
            alignment: 'center',
            image:textToBase64Barcode(code),
            margin: [0,0,0,0], //barcode的margin
            width: 300,
            height:100
        });
        ret.push({
